...
const slides = [
  {
    image: hero1,
    title: "Where Little Learners Grow Big Dreams",
    subtitle: "A nurturing preschool experience rooted in play, creativity, and love.",
  },
  {
    image: hero2,
    title: "Learning Through Joy & Discovery",
    subtitle: "Hands-on activities that spark curiosity and build confident young minds.",
  },
];
  ...
  return (
    <section id="home" className="relative h-screen min-h-[600px] max-h-[900px] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center section-padding">
        <h1
          className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-display font-bold text-primary-foreground max-w-4xl text-balance animate-fade-in-up"
        ...
        <a
          href="#admissions"
          className="mt-8 bg-primary text-primary-foreground font-bold font-body px-8 py-4 rounded-xl text-lg hover:opacity-90 active:scale-[0.97] transition-all shadow-xl shadow-primary/30 animate-fade-in-up"
