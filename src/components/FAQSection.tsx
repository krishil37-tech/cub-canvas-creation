...
const defaultFaqs = [
  { q: "What age groups do you accept?", a: "We accept children from 1.5 years to 5.5 years across our Playgroup, Nursery, Jr. KG, and Sr. KG programs." },
  { q: "What is the student-teacher ratio?", a: "We maintain a low 10:1 student-teacher ratio to ensure personalized attention for every child." },
  { q: "What curriculum do you follow?", a: "We follow a play-based learning curriculum that integrates early literacy, numeracy, arts, music, and outdoor exploration." },
  { q: "What are the school timings?", a: "Playgroup: 9:00 AM – 11:30 AM. Nursery to Sr. KG: 8:30 AM – 12:30 PM. Extended daycare available until 4:00 PM." },
  { q: "Is transportation available?", a: "Yes, we offer safe and supervised bus transportation covering major areas in Vadodara." },
];
...
export default function FAQSection() {
  ...
  const faqs = getJSON<typeof defaultFaqs>("faq", "items", defaultFaqs);
